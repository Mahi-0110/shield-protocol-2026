      ...
      <AnimatePresence>
        {toastMessage && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 20 }}
            className="fixed bottom-20 left-1/2 -translate-x-1/2 z-50 px-4 py-2 rounded-xl bg-blue-primary text-white font-space font-semibold text-xs shadow-2xl flex items-center gap-2 border border-blue-accent/30"
          >
